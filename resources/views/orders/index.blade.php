                ...
                <div class="card-body">
                    <form action="">
                        <div class="input-group input-group-sm" >
                            <input type="text"
                                data-url="{{ route('searchAjax', ['type' => 'orders', 'status' => isset($status) ? $status : null]) }}"
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-tools">
                        ...
                        <button class="btn btn-xs btn-info float-right" onclick="exportTableToCSV('orders.csv')">Export To
                            CSV</button>
                    </div>
                </div>
                <div class="card-body">
