                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('style_no', null, ['class' => 'form-control', 'id' => 'style_no', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('delivery_date_interval', null, ['class' => 'form-control', 'id' => 'delivery_date_interval', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_po_purch_recvd_d"><strong>Product purchase Received Date
                                                        (A)</strong></label>
                                                {!! Form::text('pl_po_purch_recvd_d', custom_date($order->pl_po_purch_recvd_d), ['class' => 'form-control', 'id' => 'pl_po_purch_recvd_d', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_req_delv_dt"><strong>Required Delivery Date
                                                        (A+50)</strong></label>
                                                {!! Form::text('pl_req_delv_dt', custom_date($order->pl_req_delv_dt), ['class' => 'form-control', 'id' => 'pl_req_delv_dt', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_lead_time', custom_date($order->pl_lead_time), ['class' => 'form-control', 'id' => 'pl_lead_time', 'readonly' => true]) !!}
                                                @error('pl_lead_time')
                                                    <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_yern_recei_s_dt"><strong>Yarn Receipt Start Date
                                                        (A+10)</strong></label>
                                                {!! Form::text('pl_yern_recei_s_dt', custom_date($order->pl_yern_recei_s_dt), ['class' => 'form-control', 'id' => 'pl_yern_recei_s_dt', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_yern_recei_e_dt"><strong>Yarn Receipt End Date
                                                        (A+15)</strong></label>
                                                {!! Form::text('pl_yern_recei_e_dt', custom_date($order->pl_yern_recei_e_dt), ['class' => 'form-control', 'id' => 'pl_yern_recei_e_dt', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_fabric_qlt_sub_dt"><strong>Fabric Quality Subbmission Date
                                                        (A+10)</strong></label>
                                                {!! Form::text('pl_fabric_qlt_sub_dt',  custom_date($order->pl_fabric_qlt_sub_dt), ['class' => 'form-control', 'id' => 'pl_fabric_qlt_sub_dt', 'placeholder' => 'Fabric Quality Submission Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_fabric_qlt_app_dt', custom_date($order->pl_fabric_qlt_app_dt), ['class' => 'form-control', 'id' => 'pl_fabric_qlt_app_dt', 'placeholder' => 'Fabric Quality Approval Submission Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_fabric_compo_tst_sub', custom_date($order->pl_fabric_compo_tst_sub), ['class' => 'form-control', 'id' => 'pl_fabric_compo_tst_sub', 'placeholder' => 'Fabric Composition Test Submission', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_fabric_compo_tst_app"><strong>Fabric Composition Test
                                                        Approval
                                                        (A+15)</strong></label>
                                                {!! Form::text('pl_fabric_compo_tst_app', custom_date($order->pl_fabric_compo_tst_app), ['class' => 'form-control', 'id' => 'pl_fabric_compo_tst_app', 'placeholder' => 'Fabric Composition Test Approval', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_fabric_qlt_tst_sub"><strong>Fabric Quality Test Submission
                                                        (A+8)</strong></label>
                                                {!! Form::text('pl_fabric_qlt_tst_sub', custom_date($order->pl_fabric_qlt_tst_sub), ['class' => 'form-control', 'id' => 'pl_fabric_qlt_tst_sub', 'placeholder' => 'Fabric Quality Test Submission', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_fabric_qlt_tst_app_dt"><strong>Fabric Quality Test Approval
                                                        Date (A+17)</strong></label>
                                                {!! Form::text('pl_fabric_qlt_tst_app_dt', custom_date($order->pl_fabric_qlt_tst_app_dt), ['class' => 'form-control', 'id' => 'pl_fabric_qlt_tst_app_dt', 'placeholder' => 'Fabric Subbmission Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_sss_samp_sub_dt"><strong>SSS Sample Submission Date
                                                        (A+13)</strong></label>
                                                {!! Form::text('pl_sss_samp_sub_dt', custom_date($order->pl_sss_samp_sub_dt), ['class' => 'form-control', 'id' => 'pl_sss_samp_sub_dt', 'placeholder' => 'SSS Sample Submission Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_sss_app_dt', custom_date($order->pl_sss_app_dt), ['class' => 'form-control', 'id' => 'pl_sss_app_dt', 'placeholder' => 'SSS Approval Date', 'readonly' => true]) !!}
                                                @error('pl_sss_app_dt')
                                                    <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_knitting_s_dt"><strong>Knitting Start Date
                                                        (A+14)</strong></label>
                                                {!! Form::text('pl_knitting_s_dt', custom_date($order->pl_knitting_s_dt), ['class' => 'form-control', 'id' => 'pl_knitting_s_dt', 'placeholder' => 'Knitting Start Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_knitting_e_dt"><strong>Knitting End Date
                                                        (A+28)</strong></label>
                                                {!! Form::text('pl_knitting_e_dt', custom_date($order->pl_knitting_e_dt), ['class' => 'form-control', 'id' => 'pl_knitting_e_dt', 'placeholder' => 'Knitting End Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_dyeing_s_dt"><strong>Dyeing Start Date
                                                        (A+18)</strong></label>
                                                {!! Form::text('pl_dyeing_s_dt', custom_date($order->pl_dyeing_s_dt), ['class' => 'form-control', 'id' => 'pl_dyeing_s_dt', 'placeholder' => 'Dyeing Start Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_dyeing_e_dt',  custom_date($order->pl_dyeing_e_dt), ['class' => 'form-control', 'id' => 'pl_dyeing_e_dt', 'placeholder' => 'Dyeing End Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_sewing_acce_tst_sub', custom_date($order->pl_sewing_acce_tst_sub), ['class' => 'form-control', 'id' => 'pl_sewing_acce_tst_sub', 'placeholder' => 'Sewing Accessories Test Subbmission', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_sewing_acce_inhouse_dt', custom_date($order->pl_sewing_acce_inhouse_dt), ['class' => 'form-control', 'id' => 'pl_sewing_acce_inhouse_dt', 'placeholder' => 'Sewing Accessories Inhouse Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_packing_acce_tst_sub', custom_date($order->pl_packing_acce_tst_sub), ['class' => 'form-control', 'id' => 'pl_packing_acce_tst_sub', 'placeholder' => 'Packing Accessories Test Submission', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_packing_acce_inhouse_dt', custom_date($order->pl_packing_acce_inhouse_dt), ['class' => 'form-control', 'id' => 'pl_packing_acce_inhouse_dt', 'placeholder' => 'Packing Accessories Inhouse Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_cutting_s_dt"><strong>Cutting Start Date
                                                        (A+25)</strong></label>
                                                {!! Form::text('pl_cutting_s_dt', custom_date($order->pl_cutting_s_dt), ['class' => 'form-control', 'id' => 'pl_cutting_s_dt', 'placeholder' => 'Cutting Start Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_cutting_e_dt"><strong>Cutting End Date
                                                        (A+40)</strong></label>
                                                {!! Form::text('pl_cutting_e_dt', custom_date($order->pl_cutting_e_dt), ['class' => 'form-control', 'id' => 'pl_cutting_e_dt', 'placeholder' => 'Cutting End Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_print_emb_s_dt"><strong>Print/EMB Start Date
                                                        (A+26)</strong></label>
                                                {!! Form::text('pl_print_emb_s_dt', custom_date($order->pl_print_emb_s_dt), ['class' => 'form-control', 'id' => 'pl_print_emb_s_dt', 'placeholder' => 'Print/EMB Start Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_print_emb_e_dt"><strong>Print/EMB End Date
                                                        (A+42)</strong></label>
                                                {!! Form::text('pl_print_emb_e_dt', custom_date($order->pl_print_emb_e_dt), ['class' => 'form-control', 'id' => 'pl_print_emb_e_dt', 'placeholder' => 'Print/EMB End Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_sewing_s_dt"><strong>Sewing Start Date
                                                        (A+28)</strong></label>
                                                {!! Form::text('pl_sewing_s_dt', custom_date($order->pl_sewing_s_dt), ['class' => 'form-control', 'id' => 'pl_sewing_s_dt', 'placeholder' => 'Sewing Start Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_sewing_e_dt', custom_date($order->pl_sewing_e_dt), ['class' => 'form-control', 'id' => 'pl_sewing_e_dt', 'placeholder' => 'Sewing End Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_finish_s_dt"><strong>Finishing Start Date
                                                        (A+29)</strong></label>
                                                {!! Form::text('pl_finish_s_dt', custom_date($order->pl_finish_s_dt), ['class' => 'form-control', 'id' => 'pl_finish_s_dt', 'placeholder' => 'Finishing Start Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_finish_e_dt"><strong>Finishing End Date
                                                        (A+46)</strong></label>
                                                {!! Form::text('pl_finish_e_dt', custom_date($order->pl_finish_e_dt), ['class' => 'form-control', 'id' => 'pl_finish_e_dt', 'placeholder' => 'Finishing End Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_midline_inspec_dt"><strong>Mid Line Inspaction Date
                                                        (A+34)</strong></label>
                                                {!! Form::text('pl_midline_inspec_dt', custom_date($order->pl_midline_inspec_dt), ['class' => 'form-control', 'id' => 'pl_midline_inspec_dt', 'placeholder' => 'Mid Line Inspaction Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_final_inspec_dt"><strong>Final Inspaction Date
                                                        (A+48)</strong></label>
                                                {!! Form::text('pl_final_inspec_dt', custom_date($order->pl_final_inspec_dt), ['class' => 'form-control', 'id' => 'pl_final_inspec_dt', 'placeholder' => 'Final Inspaction Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_shipment_dt', custom_date($order->pl_shipment_dt), ['class' => 'form-control', 'id' => 'pl_shipment_dt', 'placeholder' => 'Shipment Date', 'readonly' => true]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ route('imagecache', ['template' => 'sbixs', 'filename' => $order->fi()]) }}"
                                                    alt="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_buld_fab_qlt_app_dt"><strong>BulkFabric Quality Approval
                                                        date</strong></label>
                                                {!! Form::text('pl_buld_fab_qlt_app_dt', custom_date($order->pl_buld_fab_qlt_app_dt), ['class' => 'form-control', 'id' => 'pl_buld_fab_qlt_app_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_lab_dip_app_dt"><strong>Lab dip Approval
                                                        Date</strong></label>
                                                {!! Form::text('pl_lab_dip_app_dt', custom_date($order->pl_lab_dip_app_dt), ['class' => 'form-control', 'id' => 'pl_lab_dip_app_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_print_app_dt"><strong>Garment Approval Date</strong></label>
                                                {!! Form::text('pl_print_app_dt', custom_date($order->pl_print_app_dt), ['class' => 'form-control', 'id' => 'pl_print_app_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_pp_app_dt', custom_date($order->pl_pp_app_dt), ['class' => 'form-control', 'id' => 'pl_pp_app_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_size_set_app_dt"><strong>Size Set Approval
                                                        Date</strong></label>
                                                {!! Form::text('pl_size_set_app_dt', custom_date($order->pl_size_set_app_dt), ['class' => 'form-control', 'id' => 'pl_size_set_app_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_fabric_ready_dt', custom_date($order->pl_fabric_ready_dt), ['class' => 'form-control', 'id' => 'pl_fabric_ready_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_cutting_dt', custom_date($order->pl_fabric_ready_dt), ['class' => 'form-control', 'id' => 'pl_cutting_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_sewing_prod_day', custom_date($order->pl_sewing_prod_day), ['class' => 'form-control', 'id' => 'pl_sewing_prod_day', 'placeholder' => 'Sewing prod day', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_sewing_compl_dt"><strong>Sewing Completion
                                                        Date</strong></label>
                                                {!! Form::text('pl_sewing_compl_dt', custom_date($order->pl_sewing_compl_dt), ['class' => 'form-control', 'id' => 'pl_sewing_compl_dt', 'placeholder' => 'Sewing Completion  Date', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="pl_finish_compl_dt"><strong>Finishing Completion
                                                        Date</strong></label>
                                                {!! Form::text('pl_finish_compl_dt', custom_date($order->pl_finish_compl_dt), ['class' => 'form-control', 'id' => 'pl_finish_compl_dt', 'placeholder' => 'Finishing  Completion Date', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_final_inspec_dt', custom_date($order->pl_final_inspec_dt), ['class' => 'form-control', 'id' => 'pl_final_inspec_dt', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                {!! Form::text('pl_value', null, ['class' => 'form-control', 'id' => 'pl_value', 'placeholder' => 'Value', 'readonly' => true]) !!}
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="al_germent_details"><strong>Garment Details</strong></label>
                                                {!! Form::textarea('al_germent_details', null, ['class' => 'form-control', 'id' => 'al_germent_details', 'rows' => 2]) !!}
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="al_yern_details"><strong>Yarn Details</strong></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="al_yern_recei_s_dt"><strong>Yarn Receipt Start Date
                                                        (A+10)</strong></label>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="al_yern_recei_e_dt"><strong>Yarn Receipt End Date
                                                        (A+15)</strong></label>
                                        ...
                                        <div class="col-md-12" id="color">
                                            <div class="card-body bg-info">
                                                <h4 id="colorPart">Color Wise Details</h4>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="al_fabric_consumtion" id="al_fabric_consumtion"
                                                    class="form-control">
                                                    <option value="" selected>Select Fabric Consumtion</option>
                                                    <option {{ $order->al_fabric_consumtion == 'kg' ? 'selected' : '' }}
                                                        value="kg">KG</option>
                                                    <option {{ $order->al_fabric_consumtion == 'dzn' ? 'selected' : '' }}
                                                        value="dzn">Dogne</option>
                                                </select>
                                                ...
                                                <div class="card w3-border w3-border-blue">
                                                    <div class="card-body ">
                                                        <table class="table table-bordered table-sm w3-border w3-border-blue">
                                                            ...
                                                            @foreach ($order->alcolorquantity as $item)
                                                                <tr>
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        {!! Form::text('al_color_name[0]', null, ['class' => 'form-control', 'id' => 'al_color_name', 'alaceholder' => 'Color Name']) !!}
                                                                        @error('al_color_name')
                                                                            <span class="text-danger"> {{ $message }}</span>
                                                                        @enderror
                                                                    </div>
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        <label for="al_color_wise_qty"><strong> Colour wise
                                                                                Qty</strong></label>
                                                                        {!! Form::number('al_color_wise_qty[0]', null, ['class' => 'form-control', 'id' => 'al_color_wise_qty', 'alaceholder' => 'Colour wise  Quantity']) !!}
                                                                ...
                                                                <div class="col-md-3">
                                                                    <div class="form-group">
                                                                        ...
                                                                        {!! Form::text('al_print_name[0]', null, ['class' => 'form-control', 'id' => 'al_print_name', 'alaceholder' => ' Print name']) !!}
                                                                        @error('al_print_name')
                                                                            <span class="text-danger"> {{ $message }}</span>
                                                                        @enderror
                                                                    </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label for="al_value"><strong>Final Shipped Value</strong></label>
                                                {!! Form::text('al_value', $order->al_value, ['class' => 'form-control', 'id' => 'al_value', 'alaceholder' => 'Value']) !!}
                                                @error('al_value')
                                                    <span class="text-danger"> {{ $message }}</span>
                                                @enderror
                                            </div>
    ...
    <script>
        ...
        $('#addMore').click(function() {
            ...
            $('#dynamicColor').prepend(
                '<div class="row"><div class="col-md-3"> <div class="form-group"><label for="al_color_name"><strong> Color Name</strong></label><input type="text" name="al_color_name[' +
                i +
                ']" class="form-control" id="al_color_name" placeholder="Color name"/></div></div><div class="col-md-3"><div class="form-group"><label for="al_color_wise_qty"><strong> Colour wise Qty</strong></label><input type="text" name="al_color_wise_qty[' +
                i +
                ']" class="form-control" id="al_color_wise_qty" placeholder="Color Wise Quantity"/></div></div><div class="col-md-3"><div class="form-group"><label for="al_color_wise_qty"><strong> Print Name</strong></label><input type="text" name="al_print_name[' +
                i +
