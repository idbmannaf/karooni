...
{{--   <div class="preloader flex-column justify-content-center align-items-center">
    <img class="animation__shake" src="{{asset('alte/dist/img/AdminLTELogo.png')}}" alt="AdminLTELogo" height="60" width="60">
  </div>
 --}}
...
{{-- <script src="{{asset('alte/plugins/jquery.dateentry/jquery.dateentry.min.js')}}"></script> --}}
